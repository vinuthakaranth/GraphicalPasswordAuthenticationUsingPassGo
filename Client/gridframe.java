...
class paintPanel extends JPanel implements ChangeListener,MouseMotionListener,MouseListener
{
 JFrame frm;
 JLabel cho;

  public paintPanel( JFrame frm)	//constructor
  {
  ...
  frm=this.frm;
   ...
   p.setBounds(430,180,150,100);
   p.setVisible(true);

       cho.setBounds(430,150,150,25);
...
strt = strt.substring( 0, strt.lastIndexOf(","));
		...
		ps.println("insert");
		ps.println(usrname.uname.getText());
		ps.println(strt);
		ps.println(iname);
		ps.println(sca+"");
	  	 ...
	  	 frm1.setVisible(false);
					...
					if(s.size() >0) {
							...
							String st=(String)s.peek();
                   				...
                   				if(s.size() ==0) {	slidex.enable();
                   					SwingUtilities.updateComponentTreeUI(paintPanel.this);
                   				}
            ...
            slidex.setMajorTickSpacing(5);
               ...
               slidex.setBackground(Color.lightGray);
				...
				bt.setBounds(430,350,100,50);
				pass.setBounds(50,10,150,50);

				clear.setBounds(430,50,100,30);
				Undo.setBounds(430,100,100,30);
       ...
       // g.drawRect(50,50,250,250); //optional
         ...
         for(i=1;i<=slidex.getValue();i++)
           ...
           for( i=0;i<count1;i++) {
				...
				g.drawString("Read the following instructions",620,70);
				g.drawString("1.Select an image of your choice",620,100);
				g.drawString("2.Select the slider value",620,130);
				g.drawString("3.Draw password on intersection points ",620,160);
}
...
gridframe()
{
	...
	Jfrm.setSize(880,550);
	Jfrm.setLocation(120,100);
