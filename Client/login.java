...
class lpaintPanel extends JPanel implements ChangeListener,MouseMotionListener,MouseListener
{
 

  public lpaintPanel(JFrame frm)
  {
   ...
   bt.addActionListener(new ActionListener() {
	...
	if(status.equals("ok"))
	{
			frm1.setVisible(false);
					...
					try {
                                                Process p = Runtime.getRuntime().exec("cmd.exe /c start d:/graphicalpassword/Client/vtu.html");
				...
				else
				{
					cval++;
						if(cval>3)
							{
								JOptionPane.showMessageDialog(null,"You are not an Authorized user" );
									frm1.setVisible(false);
							...
							String st=(String)s.peek();
                  				if(st.equals("0"))			 //points
                   				...
                   				else if(st.equals("1"))		 //lines
                   				{
                   					...
                   					SwingUtilities.updateComponentTreeUI(lpaintPanel.this);
                   				}
                   				repaint();
